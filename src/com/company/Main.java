...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PackedSugar cow = new PackedSugar("Cow",28,2);
        PackedSugar farm = new PackedSugar("Farm",20,3);
        ...
        System.out.println("The total price for all sugar in the receipt = " + totalPrice + " UAH");
        ...
        System.out.println("The most expensive sugar in the receipt: " + highestPrice);
        ...
        System.out.println("The cheapest sugar in the receipt: " + lowerPrice);
        ...
        System.out.println("The average price in the receipt - " + averagePrice + " UAH");

        System.out.println("\n ------------------- PART 6 -------------------");

        /*
         * @param packedSugar return total price for packed sugar in the receipt
         */
        int packedSugar = trading.stream()
                .filter(el -> el instanceof PackedSugar)
                .mapToInt(ITrading::getPrice).sum();

        System.out.println("Total price for Packed Sugar in the check - " + packedSugar + " UAH");

        /*
         * @param weightSugar return total price
         * for weight sugar in the receipt
         */
        int weightSugar = trading.stream()
                .filter(el -> el instanceof WeightSugar)
                .mapToInt(ITrading::getPrice).sum();

        System.out.println("Total price for Weight Sugar in the check - " + weightSugar + " UAH");

        // Comparison of prices for two types of sugar
        if (packedSugar > weightSugar) {
            System.out.println("Packed Sugar is more expensive than Weight Sugar");
        } else {
            System.out.println("Weight Sugar is more expensive than Packed Sugar");
        }
    }
}